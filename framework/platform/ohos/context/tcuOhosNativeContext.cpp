    ...
    : m_contextType(config.type)
{
    ...
    // printf("%d, %d\n", config.type.getAPI().getMajorVersion(), config.type.getAPI().getMinorVersion());

    // printf("glGetIntegerv = %p , glGetStringi=%p\n", m_glFunctions.getIntegerv, m_glFunctions.getStringi);
    ...
    // printf("glGetIntegerv = %p , gl.getStringi=%p\n", m_glFunctions.getIntegerv, m_glFunctions.getStringi);

    // egl->getConfigAttrib(dpy, config, attribute, value);
