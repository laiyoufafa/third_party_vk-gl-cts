...
bool RosenContextImpl::InitEgl()
{
    ...
    // frameBufferAttribs.push_back(5);
    // frameBufferAttribs.push_back(EGL_GREEN_SIZE);
    // frameBufferAttribs.push_back(8);
    ...
    // eglChooseConfig(eglDisplay_, &frameBufferAttribs[0], NULL, 0, &configCount_);
    // allConfigs_ = new EGLConfig[configCount_];
    // eglChooseConfig(eglDisplay_, &frameBufferAttribs[0], allConfigs_, configCount_, &configCount_);
